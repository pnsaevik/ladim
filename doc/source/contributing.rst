...
Report bugs at https://github.com/pnsaevik/ladim/issues.

If you are reporting a bug, please include

* Version number of Ladim
...
Feature proposals can be submitted at https://github.com/pnsaevik/ladim/issues.
Please beware that Ladim has a limited budget, and maintainers
will have to prioritize strictly.
...
1.  Open an issue on https://github.com/pnsaevik/ladim/issues, where you
...
3.  Fork the repo on GitHub and clone your fork locally::

     $ cd name_of_dev_dir
     $ git clone git@github.com:your_name_here/ladim.git .

4.  Use ``conda`` or ``virtualenv`` to create an isolated development
    environment. For instance, assuming that ``conda`` is installed, use::

     $ cd name_of_dev_dir
     $ conda env create -n ladim -f environment.yml
     $ conda activate ladim
     $ pip install -e .
